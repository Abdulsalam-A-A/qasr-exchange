...
function PublicPage({ onAdminClick, onGraphClick, onCurrenciesLoaded }) {
  const [currencies, setCurrencies] = useState([]);
  ...
  async function loadData() {
    const data = await fetchCurrencies();
    setCurrencies(data);
    if (onCurrenciesLoaded) onCurrenciesLoaded(data);
  ...
  return (
    <>
      <PublicPage
        ...
        onCurrenciesLoaded={setSharedCurrencies}
      />
      {showGraph && (
        <RateGraph
          currencies={sharedCurrencies}
